...
def EVAL(s, env):
    ...
    while True:
        ...
        if type(s) is list and len(s) > 0:
            ...
            # returns a function, which makes use of the Env initialiser to set parameters, which we use the evaluate the expression
        ...
        else: return evalast(s, env) # for non-list tokens.
